function load_dicomdir(dicomdirpath)
    ...
    if ~isempty(dirres1mat)
        ...
        for i = 1: NumOfField
            ...
            elseif strcmp(CurrentItemType,'IMAGE')
                ...
                if ispc 
                    if exist(strcat(dicomdirpath,CurrentItem.ReferencedFileID))
                        dcmPatient(CurrentPatient,1).Study(CurrentStudy,1).Series(CurrentSeries,1). ...
                            ImageNames{CurrentImage,1} = CurrentItem.ReferencedFileID;

                        image_name = strcat(dicomdirpath,CurrentItem.ReferencedFileID);
                        dcmPatient(CurrentPatient,1).Study(CurrentStudy,1).Series(CurrentSeries,1). ...
                            Images{CurrentImage,1} = dicomread(image_name);
                    end
                else
                    if exist(strcat(dicomdirpath,strrep(CurrentItem.ReferencedFileID,'\','/')))
                        dcmPatient(CurrentPatient,1).Study(CurrentStudy,1).Series(CurrentSeries,1). ...
                            ImageNames{CurrentImage,1} = strrep(CurrentItem.ReferencedFileID,'\','/');

                        image_name = strcat(dicomdirpath,strrep(CurrentItem.ReferencedFileID,'\','/'));
                        dcmPatient(CurrentPatient,1).Study(CurrentStudy,1).Series(CurrentSeries,1). ...
                            Images{CurrentImage,1} = dicomread(image_name);
                        dcmPatient(CurrentPatient,1).Study(CurrentStudy,1).Series(CurrentSeries,1). ...
                            ImagesInfo{CurrentImage,1} = dicominfo(image_name);
                        
                        if strcmp(dcmPatient(CurrentPatient,1).Study(CurrentStudy,1).Series(CurrentSeries,1). ...
                        SeriesDescription,'')
                            dcmPatient(CurrentPatient,1).Study(CurrentStudy,1).Series(CurrentSeries,1). ...
                        SeriesDescription = dcmPatient(CurrentPatient,1).Study(CurrentStudy,1).Series(CurrentSeries,1). ...
                            ImagesInfo{CurrentImage,1}.SeriesDescription;
                        end
                    end
                end
