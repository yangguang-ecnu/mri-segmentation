...
% aa(:,:,2) = convert2u8(handles.vol_axial(:,:,ax));%zeros(size(handles.vol_axial(:,:,ax)));
% aa(:,:,3) = convert2u8(handles.vol_axial(:,:,ax));%zeros(size(handles.vol_axial(:,:,ax)));
% 
% 
% ss(:,:,2) = convert2u8(handles.vol_sagittal(:,:,sag));
% ss(:,:,1) = convert2u8(handles.vol_sagittal(:,:,sag));%zeros(size(handles.vol_sagittal(:,:,sag)));
% ss(:,:,3) = convert2u8(handles.vol_sagittal(:,:,sag));%zeros(size(handles.vol_sagittal(:,:,sag)));
% 
% cc(:,:,3) = convert2u8(handles.vol_coronal(:,:,cor));
% cc(:,:,1) = convert2u8(handles.vol_coronal(:,:,cor));%zeros(size(handles.vol_coronal(:,:,cor)));
% cc(:,:,2) = convert2u8(handles.vol_coronal(:,:,cor));%zeros(size(handles.vol_coronal(:,:,cor)));
...
% 
% % cross_f = cross(handles.views.sagittal_info{sag}.ImageOrientationPatient(4:6),handles.views.sagittal_info{sag}.ImageOrientationPatient(1:3))
% % 
% % M(1:3,3) = cross_f .* handles.views.sagittal_info{sag}.SpacingBetweenSlices;
% 
% i = [0 511];
% j = [0 511];
% 
