...
% [in.a_y in.a_x] = ndgrid(1:in.rows, 1:in.cols);
in.a_y = 1:in.rows;
in.a_x = 1:in.cols;
...
for i = 1:in.n1
    ...
    in.axial_m1_par{i} = in.axial_m1{sub_3_int1(i)};
    in.sag_m1_par{i}   = in.sag_m1{sub_2_int1(i)};
end
...
for i = 1:in.n2
    ...
    in.axial_m1_par2{i} = in.axial_m1{sub_3_int2(i)};
    in.cor_m1_par1{i}   = in.cor_m1{sub_2_int2(i)};
end

for i = 1:in.n3
    sag_m1_par2{i} = in.sag_m1{sub_2_int3(i)};
    cor_m1_par2{i} = in.cor_m1{sub_3_int3(i)};
    in.sag_m1_par2{i} = in.sag_m1{sub_2_int3(i)};
    in.cor_m1_par2{i} = in.cor_m1{sub_3_int3(i)};
end
...
in.sub_2_int2 = sub_2_int2;
in.sub_3_int2 = sub_3_int2;

in.sub_2_int3 = sub_2_int3;
in.sub_3_int3 = sub_3_int3;

in.t = t;
in.current_tr = current_tr_int1;
in.c2b_coord = c2b_coord_int1;
in.current_tr2 = current_tr_int2;
in.c2b_coord2 = c2b_coord_int2;
in.current_tr3 = current_tr_int3;
in.c2b_coord3 = c2b_coord_int3;
...
% X, Y, Z
a = repmat([1 2 3]',1,size(source_tri.X,1));
in.xyz = a(:);
