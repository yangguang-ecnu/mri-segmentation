...
for k = 1:5
    ...
    save_name2 = strcat('results_rotation_',num2str(k),'.mat');

    
    %% Add rotation
    theta = angles(k).*rand(3,1)
%     rad_15 = 15 * pi / 180;
%     rota = -rad_15;
%     rotb =  rad_15;
...
%     theta3 = rota + (rotb-rota)*rand(1);
    ...
    save(save_name,'opt_im_ax','opt_im_sag','opt_im_cor','trans','R','deform_tri_ax','deform_tri_sag','deform_tri_cor','theta1','theta2','theta3');
