function [successors,predecessors,current] = PSLz3_get_neighbors(points,imsize);
...
if dm==1,
    [dum, dum, TreeRoot_idx]    = kdtree(indexes,[]);
else
    [dum, dum, TreeRoot_idx]    = kdtree(descriptor_points,[]);
end
...
for it = 1:2,
    ...
    for n_ind = 1:3,
        ...
        [idx, n_dist, TreeRoot_idx] = kdtreeidx([], [c_m,c_n,scind/20],TreeRoot_idx);
