...
% if strcmp(dicom_series.dcmPatient.Study.Series(2,1).SeriesDescription,'SAG T2 PROPELLER')
%     series = 2;
% elseif strcmp(dicom_series.dcmPatient.Study.Series(3,1).SeriesDescription,'SAG T2 PROPELLER')
%     series = 3;
% else
