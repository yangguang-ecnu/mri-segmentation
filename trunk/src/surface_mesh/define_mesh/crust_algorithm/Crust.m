...
tic
[tbound,Ifact,tetr]=Marking(p,tetr,tetr2t,t2tetr,cc,r,nshield);%Flagging tetraedroms as inside or outside
...
[t,~,j] = unique(sort(t,2),'rows');%triangles
...
%% Marking
function [tbound,Ifact,tetr]=Marking(p,tetr,tetr2t,t2tetr,cc,r,nshield)
